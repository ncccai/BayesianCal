...
from util.model_config import CONFIGS_
...
#################################
class Net(nn.Module):
    def __init__(self, dataset='cmapss'):
        super(Net, self).__init__()
        # define network layers
        self.feature_ext, self.feature_fc, self.reg_block, self.cls_block = None, None, None, None
        ...
        self.build_network(configs, input_channel, self.output_dim)
